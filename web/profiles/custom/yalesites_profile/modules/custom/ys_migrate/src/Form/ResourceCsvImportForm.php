...
class ResourceCsvImportForm extends FormBase {
  ...
  protected function displayPreviewTable(array $resources) {
    ...
    $build = [
      ...
      '#header' => [
        ['data' => $this->t('Title'), 'scope' => 'col'],
        ['data' => $this->t('Resource Category'), 'scope' => 'col'],
        ['data' => $this->t('Publication Date'), 'scope' => 'col'],
        ['data' => $this->t('External Source'), 'scope' => 'col'],
        ['data' => $this->t('Needs media'), 'scope' => 'col'],
      ],
      '#rows' => $rows,
