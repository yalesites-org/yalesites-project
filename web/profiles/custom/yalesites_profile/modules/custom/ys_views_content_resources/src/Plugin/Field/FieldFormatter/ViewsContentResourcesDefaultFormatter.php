...
class ViewsContentResourcesDefaultFormatter extends FormatterBase implements ContainerFactoryPluginInterface {
   ...
   */
  protected ViewsContentResourcesManager $viewsContentResourcesManager;
   ...
   * @param \Drupal\ys_views_content_resources\ViewsContentResourcesManager $viewsContentResourcesManager
   *   The views basic manager service.
   */
