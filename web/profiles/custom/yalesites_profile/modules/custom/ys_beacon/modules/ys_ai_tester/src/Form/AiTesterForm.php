...
class AiTesterForm extends FormBase {
  ...
  protected function buildHistoryTable(): array {
    ...
    return [
      ...
      '#header' => [
        'date' => ['data' => $this->t('Date'), 'scope' => 'col'],
        'user' => ['data' => $this->t('User'), 'scope' => 'col'],
        'file' => ['data' => $this->t('File'), 'scope' => 'col'],
        'backend' => ['data' => $this->t('Assistant'), 'scope' => 'col'],
        'questions' => ['data' => $this->t('Questions'), 'scope' => 'col'],
        'status' => ['data' => $this->t('Status'), 'scope' => 'col'],
        'actions' => ['data' => $this->t('Actions'), 'scope' => 'col'],
      ],
      '#options' => $options,
