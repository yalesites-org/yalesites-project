...
export const XSSAllowTags = ['a', 'img', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'div', 'p', 'span', 'small', 'del', 'picture', 'i', 'u', 'sup', 'sub', 'strong', 'strike', 'code', 'pre', 'section', 'article', 'table', 'tr', 'td', 'th', 'thead', 'tbody', 'tfoot', 'ul', 'ol', 'li', 'br', 'em', 'blockquote'];
