...
export const QuestionInput = ({ onSend, disabled, placeholder, clearOnSend, conversationId, providedQuestion, describedById }: Props) => {
    ...
    return (
        <div className={styles.questionInputContainer}>
            <label htmlFor={inputId} className={styles.questionInputLabel}>Ask a question</label>
            ...
            >
                <span className={sendQuestionDisabled ? styles.questionInputSendButtonDisabled : styles.questionInputSendButton}>
