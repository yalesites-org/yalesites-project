...
class DemoContentPlusSettings extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['general']['debug'] = array(
      ...
      '#description' => $this->t('Deletes all content created by Demo Content Plus on uninstall, even if it has been edited.'),
