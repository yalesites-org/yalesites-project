...
class ModifierPluginManager extends DefaultPluginManager {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    parent::__construct(
      'Plugin/TemplateModifier',
      $namespaces,
      $module_handler,
      'Drupal\ys_templated_content\TemplateModifierInterface',
      'Drupal\ys_templated_content\Annotation\TemplateModifier'
    );

    $this->setCacheBackend($cache_backend, 'ys_templated_content_modifiers');
    $this->alterInfo('template_modifier_info');
  }
