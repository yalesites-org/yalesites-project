...
class EventMetaBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function build() {
    ...
    return [
      ...
      '#is_localist_event' => $eventFieldData['is_localist_event'],
      '#place' => $eventFieldData['place_info'],
      '#event_address' => $eventFieldData['event_address'],
      '#address_additional_info' => $eventFieldData['address_additional_info'],
