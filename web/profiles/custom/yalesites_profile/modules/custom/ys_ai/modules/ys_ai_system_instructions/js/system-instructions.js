  ...
  Drupal.behaviors.systemInstructionsCharacterCount = {
    attach: function (context, settings) {
      ...
      textarea.forEach(function (element) {
        ...
        const warningThreshold = settings.ysAiSystemInstructions?.warningThreshold || (maxLength * 0.9);
        ...
        function updateCounter() {
          ...
          $counter.text(Drupal.t('Content recommended length set to @max characters, remaining: @remaining', {
            '@max': maxLength,
            '@remaining': remaining
          }));
